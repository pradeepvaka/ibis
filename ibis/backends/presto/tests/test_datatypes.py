...
@pytest.mark.parametrize(
    ("presto_type", "ibis_type"),
    [param(presto_type, ibis_type, id=presto_type) for presto_type, ibis_type in dtypes],
)
def test_parse(presto_type, ibis_type):
    assert PrestoType.from_string(presto_type) == ibis_type
